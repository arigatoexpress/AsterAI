...
class MonteCarloSimulator:
    ...
    def __init__(self, config: MonteCarloConfig):
        ...
        logger.info(f"🎯 Target: ${config.initial_capital:.0f} → ${config.target_capital:.0f}")
    ...
    def run_simulation(self, save_paths: bool = False) -> Dict:
        ...
        logger.info(f"💰 Median final capital: ${aggregated['median_final_capital']:.2f}")
        logger.info(f"📉 Median max drawdown: {aggregated['median_max_drawdown']:.1%}")
